...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 48 - ((15 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 101 + 73) / 147)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 49 - ((11 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
exe 'vert 2resize ' . ((&columns * 76 + 73) / 147)
argglobal
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 22 - ((15 * winheight(0) + 20) / 40)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
