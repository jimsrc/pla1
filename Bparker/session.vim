...
silent only
cd ~/simulacion/pla_stochastic/composite_turbulence/single_orbits/Bparker
...
badd +0 _funcs.c
badd +18 funcs.cc
badd +0 generalidades.c
badd +0 Bparker.pyx
badd +0 setup.py
badd +0 makefile
badd +14 _cython_w.pyx
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 48 - ((15 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 91 + 66) / 132)
exe 'vert 2resize ' . ((&columns * 40 + 66) / 132)
argglobal
xnoremap <buffer> <silent> \a} `>a}`<i{
xnoremap <buffer> <silent> \a{ `>a}`<i{
xnoremap <buffer> <silent> \a) `>a)`<i(
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 49 - ((11 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 63 + 66) / 132)
exe 'vert 2resize ' . ((&columns * 68 + 66) / 132)
argglobal
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 34 - ((23 * winheight(0) + 19) / 39)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
