...
silent only
cd ~/simulacion/pla_stochastic/composite_turbulence/single_orbits/test
...
silent! normal! zE
let s:l = 32 - ((28 * winheight(0) + 18) / 36)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 130 - ((26 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
130
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 100 - ((23 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
